...
select top 100 * from Regression_interim_product_level

select top 100 * from Ad_cluster_number
...
Decline/nullif((Decline+Growth+Maturity),0) as decline_perc,
Growth/nullif((Decline+Growth+Maturity),0) as Growth_perc,
Maturity/nullif((Decline+Growth+Maturity),0) as Maturity_perc,
pos/nullif((pos+First_mk+further),0) as pos_perc,
First_mk/nullif((pos+First_mk+further),0) as First_perc,
further/nullif((pos+First_mk+further),0) as further_perc,
...
select top 10 * from Regression_ad_cat_cluster_interim
